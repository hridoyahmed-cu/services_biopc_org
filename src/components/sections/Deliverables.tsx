          ...
          <Reveal>
            <ul className="grid gap-px overflow-hidden rounded-2xl border border-[var(--hairline)] bg-[var(--hairline)] sm:grid-cols-2">
              {DELIVERABLES.map((d) => (
                <li
                  key={d.title}
                  className="flex items-start gap-3 bg-[#071228] px-5 py-4.5 transition-colors hover:bg-[#0a1830]"
                >
          ...
          <Reveal delay={120} className="lg:sticky lg:top-28 lg:self-start">
            ...
            >
              ...
              <div className="relative">
                ...
                <h3 className="mt-3 font-display text-[1.7rem] leading-tight text-white">
                ...
                <ul className="mt-6 space-y-2 font-mono text-[0.75rem] tracking-wide text-[#9fd5fb]">
