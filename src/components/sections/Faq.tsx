          ...
          <div className="lg:sticky lg:top-28 lg:self-start">
            ...
            <Reveal delay={100}>
              <div className="panel mt-8 p-6">
                <p className="text-[0.9375rem] text-[#cddff5]">
                ...
                <a
                  ...
                  className="mt-3 block text-center font-mono text-[0.7rem] tracking-wide text-muted transition-colors hover:text-[#9fd5fb]"
                >
                  {SITE.email}
                </a>
              </div>
              ...
              <Reveal key={item.q} delay={Math.min(i, 4) * 70}>
                <details className="group py-5 [&_summary::-webkit-details-marker]:hidden">
                  <summary className="flex cursor-pointer items-start justify-between gap-6 list-none">
                    <h3 className="text-[1.0625rem] font-medium leading-snug tracking-tight text-white transition-colors group-hover:text-[#9fd5fb]">
                      {item.q}
                    </h3>
                    <span className="mt-1 grid h-6 w-6 shrink-0 place-items-center rounded-full border border-[var(--hairline)] text-[#5cc6fb] transition-transform duration-300 group-open:rotate-45">
